...
namespace UnitTests
{
    ...
    public class CoverBuildingsTests
    {
        ...
        public void CoverBuildingsTests_Test1()
        {
            ...
            Assert.AreEqual(10, result, "Example 1 [3,1,4] failed");
        }
        ...
        public void CoverBuildingsTests_Test2()
        {
            ...
            var test = new CoverBuildingsClass();
            var result = test.Solution1(data1);
            Assert.AreEqual(17, result, "Example 2 [5, 3, 2, 4] failed");
        }
        ...
        public void CoverBuildingsTests_Test3()
        {
            ...
            var test = new CoverBuildingsClass();
            var result = test.Solution1(data1);
            Assert.AreEqual(19, result, "Example 3 [5, 3, 5, 2, 1] failed");
        }
        ...
        public void CoverBuildingsTests_Test4()
        {
            ...
            var test = new CoverBuildingsClass();
            var result = test.Solution1(data1);
            Assert.AreEqual(35, result, "Example 4 [7, 7, 3, 7, 7] failed");
        }
        ...
        public void CoverBuildingsTests_Test5()
        {
            ...
            var test = new CoverBuildingsClass();
            var result = test.Solution1(data1);
            Assert.AreEqual(30, result, "Example 5 [1, 1, 7, 6, 6, 6] failed");
        }
        ...
        public void CoverBuildingsTests_Test10K()
        {
            ...
            var test = new CoverBuildingsClass();
            var result = test.Solution1(data1);
            var lasts = DateTime.Now.Subtract(start).TotalSeconds;
            Assert.IsTrue( lasts < 1, "Example 10,000 - more than 1 seconds");
        }
        ...
        public void CoverBuildingsTests_Test100K()
        {
            ...
            var result = test.Solution1(data1);
            var lasts = DateTime.Now.Subtract(start).TotalSeconds;
            Assert.IsTrue(lasts < 6, "Example 100,000 - more than 6 seconds");
        }
    }
}
